...
import { SharedIntelligenceDialog } from "@/components/xp/shared-intelligence-dialog";
    ...
    >
      ...
      {message.replyTo?.messageId === 'profile' && (
        <SharedIntelligenceDialog 
          ...
          userId={message.replyTo.profileContext?.targetUserId || ""} 
          fallbackName={message.replyTo.senderName} 
