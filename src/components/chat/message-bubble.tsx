      ...
      <DialogContent className="sm:max-w-[480px] w-[95vw] rounded-[3rem] border-none shadow-[0_32px_128px_rgba(0,0,0,0.4)] p-0 overflow-hidden bg-background h-[90vh] max-h-[90vh] flex flex-col z-[2000]">
        ...
        <ScrollArea className="flex-1">
          <motion.div 
            ...
            initial="hidden"
            animate="show"
            className="p-5 md:p-8 pt-2 space-y-6 md:space-y-8"
          >
            <motion.div variants={item} className="flex flex-col items-center text-center gap-4 md:gap-6">
              <div className="relative group">
                ...
                <Avatar className={cn(
                  ...
                  <AvatarFallback className="bg-primary text-white text-3xl font-[900] uppercase">{targetName[0]}</AvatarFallback>
                </Avatar>
                {isHidden && (
              ...
              <div className="space-y-1.5">
                <h3 className="text-xl font-black uppercase tracking-tight text-foreground">@{targetName}</h3>
                <div className="flex items-center justify-center gap-2">
                  ...
                  {isHidden && (
                    <Badge variant="destructive" className="border-none text-[8px] font-black uppercase tracking-widest px-2 h-5">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <motion.div variants={item} className="p-4 md:p-5 bg-muted/30 rounded-[1.75rem] border border-transparent hover:border-primary/20 transition-all group flex flex-col gap-1.5 relative overflow-hidden">
                ...
                {isHidden ? <Lock className="h-3.5 w-3.5 text-muted-foreground/30" /> : <span className="text-xl font-black text-foreground">{context?.totalCommunities || 0}</span>}
                <p className="text-[6px] text-muted-foreground font-bold uppercase tracking-widest">Total Communities</p>
              </motion.div>

              <motion.div variants={item} className="p-4 md:p-5 bg-muted/30 rounded-[1.75rem] border border-transparent hover:border-primary/20 transition-all group flex flex-col gap-1.5 relative overflow-hidden">
                <div className="absolute -top-4 -right-4 p-8 opacity-0 group-hover:opacity-10 transition-opacity"><Users className="h-10 w-10" /></div>
                <div className="flex items-center gap-2 text-primary">
                  <Waves className="h-3.5 w-3.5" />
                  <span className="text-[7px] font-black uppercase tracking-[0.2em]">Mutual Sync</span>
                </div>
                {isHidden ? <Lock className="h-3.5 w-3.5 text-muted-foreground/30" /> : <span className="text-xl font-black text-foreground">{context?.commonCommunities || 0}</span>}
                <p className="text-[6px] text-muted-foreground font-bold uppercase tracking-widest">Shared Universes</p>
              </motion.div>
            ...
            <motion.div variants={item} className="p-5 bg-card border rounded-[2rem] space-y-3 relative overflow-hidden group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-[0.3em]">Verse Trajectory</span>
                </div>
            ...
            <motion.div variants={item} className="p-5 bg-primary/5 rounded-[2rem] border border-primary/10 space-y-2 relative overflow-hidden">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[8px] font-black uppercase tracking-[0.3em] text-primary">Intelligence Verification</span>
              </div>
