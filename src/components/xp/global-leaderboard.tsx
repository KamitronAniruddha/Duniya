...
export function GlobalLeaderboard() {
  ...
  return (
    <div className="space-y-8 pb-6">
      {/* Top 3 Podium */}
      <div className="flex flex-col md:flex-row items-end justify-center gap-3 md:gap-6 pt-10 px-4">
        {/* Rank 2 - Master Node */}
        {topThree[1] && (
          <motion.div 
          ...
          >
            <div className="relative">
              <Avatar className="h-20 w-20 border-[3px] border-slate-300 shadow-xl transition-all group-hover:scale-105">
              ...
              <div className="absolute -top-2 -right-2 h-8 w-8 bg-slate-200 rounded-xl flex items-center justify-center shadow-lg border-2 border-background">
            ...
            <div className="h-14 w-24 bg-gradient-to-b from-slate-100 to-transparent dark:from-slate-900 rounded-t-2xl border-x border-t border-slate-300/50 flex flex-col items-center justify-center shadow-inner">
        ...
        {topThree[0] && (
          ...
          >
            <div className="relative">
              ...
              <Avatar className="h-28 w-28 border-[6px] border-primary shadow-2xl transition-all group-hover:scale-105">
              ...
              <div className="absolute -top-4 -right-4 h-12 w-12 bg-primary rounded-2xl flex items-center justify-center shadow-2xl border-4 border-background -rotate-6 group-hover:rotate-0 transition-transform">
                <Crown className="h-6 w-6 text-white fill-white" />
              </div>
            </div>
            <div className="text-center">
              <h4 className="text-base font-black uppercase tracking-tighter text-foreground truncate max-w-[150px]">@{topThree[0].username}</h4>
              <div className="flex items-center justify-center gap-1 text-xs font-black text-primary uppercase">
                <Sparkles className="h-3 w-3 fill-current" /> {topThree[0].xp} XP
              </div>
            </div>
            <div className="h-20 w-32 bg-gradient-to-b from-primary/20 to-transparent rounded-t-3xl border-x border-t border-primary/40 flex flex-col items-center justify-center relative overflow-hidden shadow-inner">
        ...
        {topThree[2] && (
          ...
          >
            <div className="relative">
              <Avatar className="h-16 w-16 border-[3px] border-amber-600/50 shadow-xl transition-all group-hover:scale-105">
              ...
              <div className="absolute -top-1.5 -right-1.5 h-7 w-7 bg-amber-600 rounded-xl flex items-center justify-center shadow-lg border-2 border-background">
                <Medal className="h-3.5 w-3.5 text-white" />
              </div>
            </div>
            <div className="text-center">
              <h4 className="text-[11px] font-black uppercase tracking-tight text-foreground truncate max-w-[80px]">@{topThree[2].username}</h4>
            ...
            <div className="h-12 w-20 bg-gradient-to-b from-amber-50 to-transparent dark:from-amber-950/30 rounded-t-xl border-x border-t border-amber-600/30 flex flex-col items-center justify-center shadow-inner">
            ...
            {others.map((leader, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1 text-[9px] font-black text-primary uppercase bg-primary/5 px-2 py-1 rounded-lg">
